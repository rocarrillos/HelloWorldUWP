...
void ::HelloWorldUWP::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::HelloWorldUWP::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 7:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::Button^>(this->inputButton))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::HelloWorldUWP::MainPage::*)
                    (::Platform::Object^, ::Windows::UI::Xaml::RoutedEventArgs^))&MainPage::Button_Click);
                (safe_cast<::Windows::UI::Xaml::Controls::Button^>(this->inputButton))->Tapped += ref new ::Windows::UI::Xaml::Input::TappedEventHandler(this, (void (::HelloWorldUWP::MainPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::HelloWorldUWP::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
